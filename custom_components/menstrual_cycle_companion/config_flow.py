"""Config flow for Menstrual Cycle Companion."""
...
class MenstrualCycleCompanionConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Menstrual Cycle Companion."""
