"""Repair handlers for menstrual_cycle_companion integration."""
...
OLD_DOMAIN = "menstrual_cycle_companion"
...
def async_create_migration_issue(
    ...
    async_create_issue(
        ...
        title="Menstrual Cycle Companion: Integration Migration Required",
...
class MigrationRepairFlow(RepairsFlow):
    """Repair flow to migrate a *menstrual_cycle_companion* config entry to *menstrual_cycle_companion*.
