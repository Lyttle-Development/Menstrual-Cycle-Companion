...
def _model_attributes(runtime: Any, entry: ConfigEntry, today: date) -> dict[str, StateType]:
    ...
    return {
        # Current phase and phase boundaries.
        ...
        ATTR_OVULATION_START: model.ovulation_date if has_history else None,
        ATTR_OVULATION_END: model.ovulation_date if has_history else None,
        ...
        # Recorded history and duration values.
